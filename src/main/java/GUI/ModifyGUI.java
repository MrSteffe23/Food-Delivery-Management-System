...
public class ModifyGUI extends JFrame {
    ...
    public ModifyGUI() {
        ...
        JLabel lblProductSpec = new JLabel("Modify Product Specifications");
    ...
    public void setRating(double rating) {
        textField_1.setText(rating + "");
    }

    public void setCalories(int calories) {
        textField_2.setText(calories + "");
    }

    public void setProtein(int protein) {
        textField_3.setText(protein + "");
    }

    public void setFat(int fat) {
        textField_4.setText(fat + "");
    }

    public void setSodium(int sodium) {
        textField_5.setText(sodium + "");
    }
